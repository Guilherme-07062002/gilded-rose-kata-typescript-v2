...
describe('testing gilded rose', () => {
  ...
  describe ('Backstage passes to a TAFKAL80ETC concert', () => {
    it('should increase quality by 1', () => {
      const given = [new Item('Backstage passes to a TAFKAL80ETC concert', 20, 10)];
      const gildedRose = new GildedRose(given);
    ...
    it('should increase quality by 2 when sellIn is 10 or less', () => {
      const given = [new Item('Backstage passes to a TAFKAL80ETC concert', 10, 10)];
      const gildedRose = new GildedRose(given);
    ...
    it('should increase quality by 3 when sellIn is 5 or less', () => {
      const given = [new Item('Backstage passes to a TAFKAL80ETC concert', 5, 10)];
      const gildedRose = new GildedRose(given);
    ...
    it('should drop quality to 0 after sellIn date', () => {
      const given = [new Item('Backstage passes to a TAFKAL80ETC concert', 0, 10)];
      const gildedRose = new GildedRose(given);
